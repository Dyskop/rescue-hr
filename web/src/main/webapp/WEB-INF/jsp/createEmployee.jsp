        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-md-6">
                <div class="card px-5 py-5"><span class="circle"><i class="fa fa-check"></i></span>
                    <form action="${pageContext.request.contextPath}/admin/employees/create" method="post">
                        ...
                        <div class="d-grid gap-2">
                            <button class="btn btn-primary mt-4 signup" style="background-color: #332464">Добавить</button>
                        </div>
                    </form>
                </div>
            </div>
